...
$cxxflags = '-std=c++17 -O3 -D_REENTRANT -DBOOST_DISABLE_ASSERTS -D_BOOST_LGAMMA -DTBB_INTERFACE_NEW -Wno-sign-compare -Wno-deprecated-builtins -Wno-ignored-attributes -shared'
$cppflags = "-I $conda_library_path\include\ -I $cmdstan_location/stan/src -I $cmdstan_location/stan/lib/rapidjson_1.1.0/ -I $cmdstan_location/stan/lib/stan_math/ -I $cmdstan_location/stan/lib/stan_math/lib/eigen_3.4.0 -I $cmdstan_location/stan/lib/stan_math/lib/boost_1.87.0 $pybind_includes"
